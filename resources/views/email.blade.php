...
<body class="p-6 bg-gray-100">
    <main class="flex flex-col w-screen h-screen">
        <section class="flex items-center justify-center flex-grow w-full p-4 bg-zinc-200">
                ...
                <div class="flex flex-col flex-grow h-full px-10 py-8 bg-zinc-900 rounded-r-3xl">
                    <div class="flex items-center justify-between w-full">
                        ...
                        <div class="flex flex-col items-center flex-grow px-10">
                            <span class="text-xs font-bold">RS 11</span>
                            ...
                            <div class="flex items-center h-8 px-3 mt-2 rounded-full bg-lime-400">
                                <span class="text-sm text-zinc-900">18h 35m</span>
                            </div>
                        </div>
                        <div class="flex flex-col items-center">
                            <span class="text-4xl font-bold">ATH</span>
                            <span class="text-sm text-zinc-500">Athens</span>
                        </div>
                    </div>
